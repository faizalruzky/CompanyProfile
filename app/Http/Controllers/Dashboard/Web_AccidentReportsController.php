...
class Web_AccidentReportsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard/hse_accidentreports.index', compact('web_accidentreports'));
    }
    ...
    {
        return view('dashboard/hse_accidentreports.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('dashboard/hse_accidentreports.show', compact('web_accidentreport'));
    }
    ...
    {
        $web_accidentreport = Web_AccidentReport::findOrFail($id);
        return view('dashboard/hse_accidentreports.edit', compact('web_accidentreport'));
    }
