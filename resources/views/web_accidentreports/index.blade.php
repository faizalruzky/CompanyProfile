  ...
  <div class="container">
    ...
    <div class="panel panel-info">
      <div class="panel-heading">
        ...
        <a href="{{ url('web_accidentreports/create') }}" class="btn btn-primary pull-right">
      ...
      <div class="panel-body">
        ...
        <div class="table-responsive">
          ...
          @foreach ($web_accidentreports as $web_accidentreport)
            <tr>
              <td><a href="{{ url("web_accidentreports", $web_accidentreport->id) }}">{{ $web_accidentreport->title }}</a></td>
